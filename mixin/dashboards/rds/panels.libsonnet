...

{
  timeSeries: {
    ...
    active_session: self.short,
    Queries_ps: self.short,
    Slow_queries_ps: self.short,
    TPS: self.short,
    QPS: self.short,
    CpuUsage: self.short,
    DiskUsage: self.short,
    IOPSUsage: self.short,
    MemoryUsage: self.short,
    Key_usage_ratio: self.short,
    Key_read_hit_ratio: self.short,
    Key_write_hit_ratio: self.short,
